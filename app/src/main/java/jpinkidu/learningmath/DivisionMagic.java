...
public class DivisionMagic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_magic);
    ...
    private void getResult() {
        ...
        Log.v(TAG, "sum" + div);
        divText = Integer.toString(div);
        mSolution.setText(divText);
