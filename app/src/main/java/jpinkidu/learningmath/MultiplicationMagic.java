...
public class MultiplicationMagic extends AppCompatActivity {
    private static final String TAG = "Multiplication";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_magic);
    ...
    private void getResult() {
        ...
        Log.v(TAG, "mult" + mult);
        multText = Integer.toString(mult);
        mSolution.setText(multText);
